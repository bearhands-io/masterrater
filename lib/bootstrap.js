...
var CompanyService = require('./biz/CompanyService'),
    ...
    ClaimService = require('./biz/ClaimService'),
...
var CompanySaveController = require('./mvc/controllers/CompanySaveController'),
    ...
    EmailTest = require('./mvc/controllers/EmailTest'),
    ClaimController = require('./mvc/controllers/ClaimController')
...
module.exports = function(app, passport) {
    ...
    app.get('/claimrequest.html', isLoggedIn, function(req, res) {
        res.render('claimrequest.ejs', {
            user : req.user // get the user out of session and pass to template
        });
    });

    // =====================
    // EMAILTEST STARTS HERE
    // =====================
    app.get('/emailtest.html', app.controllers.emailTest.test);
    app.get('/emailview.html', function(req, res) {
        res.render('emailtemplate.ejs', {
            user : req.user // get the user out of session and pass to template
        });
    });
