...
module.exports = function(app, passport) {
	...
	// BRAD STARTS HERE
	// =====================
	app.get('/', isLoggedIn, app.controllers.ratesController.getForm);
	app.get('/index.html', isLoggedIn, app.controllers.ratesController.getForm);
	app.get('/rates', isLoggedIn, app.controllers.ratesController.getForm);
	...
	app.get('/rates/', isLoggedIn, app.controllers.ratesController.getShippingRates);
